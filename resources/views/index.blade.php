          ...
          <div class="w-px-400 mx-auto">
            ...
            <div class="app-brand mb-3">
              <a class="app-brand-link gap-2">
                <img src="#" class="logo-container" alt="Login" style="width: 10%;">
                <span class="app-brand-text demo text-body fw-bold text-uppercase">Laravel Project x Sneat UIs</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">Welcome to Laravel Project x Sneat UI</h4>
            ...
            <form id="loginForm" class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="email" name="email" placeholder="@email.com" autofocus />
